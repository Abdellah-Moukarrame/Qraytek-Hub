        ...
        <div class="hidden lg:flex lg:w-3/5 relative overflow-hidden bg-primary">
            ...
            <div class="relative z-20 flex flex-col justify-end p-20 text-white max-w-2xl">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <img src="{{ asset('images/logo.png') }}" alt="EduIndependent" class="h-24 w-auto object-contain">
                </div>
                ...
                <div class="mt-10 space-y-4">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-white/90 text-sm font-medium">Automated bookings & scheduling</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-white/20 rounded-lg shrink-0">
                            <span class="material-symbols-outlined text-white text-xl">payments</span>
                        </div>
                        <span class="text-white/90 text-sm font-medium">Secure & automated payments</span>
                    </div>
                    <div class="flex items-center gap-3">
                        <div class="p-2 bg-white/20 rounded-lg shrink-0">
                            <span class="material-symbols-outlined text-white text-xl">insights</span>
                        </div>
                        <span class="text-white/90 text-sm font-medium">Comprehensive student progress tracking</span>
                    </div>
                </div>
            ...
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="grid grid-cols-2 gap-4 mb-8">
                    ...
                    <button type="button" onclick="selectRole('student')" id="role-student"
                        class="role-btn relative flex flex-col items-center gap-3 p-5 rounded-xl border-2 border-primary bg-primary/5 transition-all group">
                        <div class="absolute top-2 right-2" id="check-student">
                        ...
                        <div class="text-center">
                            <span class="block font-bold text-slate-900 dark:text-white">Student/Parent</span>
                            <span class="text-xs text-slate-500 dark:text-slate-400">Access lessons</span>
                        </div>
                    </button>

                    {{-- Teacher Option --}}
                    <button type="button" onclick="selectRole('teacher')" id="role-teacher"
                        class="role-btn relative flex flex-col items-center gap-3 p-5 rounded-xl border-2 border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-900 hover:border-primary/50 transition-all group">
                ...
                <form method="POST" action="{{ route('register.store') }}" class="space-y-5">
                    ...
                    {{-- <div>
                        ...
                        <input id="phone" name="phone" type="tel" value="{{ old('phone') }}"
                            ...
                            class="w-full h-12 px-4 rounded-lg bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-primary focus:border-primary text-slate-900 dark:text-white placeholder:text-slate-400 @error('phone') border-red-500 @enderror" />
                        @error('phone')
                            <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div> --}}
